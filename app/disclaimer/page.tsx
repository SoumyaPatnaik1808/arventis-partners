    ...
    <div className="relative w-full overflow-hidden bg-slate-50 text-primary-navy min-h-screen font-sans">
      ...
      <section className="relative w-full py-20 px-6 md:px-16 text-primary-navy">
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          {/* Highlight Card */}
          <div className="scroll-fade-up p-8 bg-white border-l-4 border-primary-gold shadow-md rounded-[1px] space-y-3">
            <div className="flex items-center gap-3 text-primary-navy">
              <ShieldAlert className="w-5 h-5 text-primary-gold-dark flex-shrink-0" />
              <h3 className="font-serif text-xl font-semibold">Bar Council Compliance Notice</h3>
            </div>
            <p className="font-sans text-xs sm:text-sm text-primary-navy/80 leading-relaxed font-light">
          ...
          <div className="scroll-fade-up bg-white p-8 md:p-10 border border-primary-navy/10 shadow-sm space-y-4">
            <h3 className="font-serif text-2xl font-light text-primary-navy border-b border-primary-navy/10 pb-4 flex items-center gap-3">
              <Scale className="w-5 h-5 text-primary-gold-dark" />
              <span>1. Purpose of Information & Non-Solicitation</span>
            </h3>
            <div className="space-y-3 font-sans text-xs sm:text-sm text-primary-navy/75 leading-relaxed font-light">
              <p>
          ...
          <div className="scroll-fade-up bg-white p-8 md:p-10 border border-primary-navy/10 shadow-sm space-y-4">
            <h3 className="font-serif text-2xl font-light text-primary-navy border-b border-primary-navy/10 pb-4 flex items-center gap-3">
              <FileText className="w-5 h-5 text-primary-gold-dark" />
          ...
          <div className="scroll-fade-up bg-white p-8 md:p-10 border border-primary-navy/10 shadow-sm space-y-4">
            <h3 className="font-serif text-2xl font-light text-primary-navy border-b border-primary-navy/10 pb-4 flex items-center gap-3">
              <CheckCircle2 className="w-5 h-5 text-primary-gold-dark" />
            ...
            <div className="space-y-3 font-sans text-xs sm:text-sm text-primary-navy/75 leading-relaxed font-light">
              ...
              <div className="pt-4">
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-2 bg-primary-navy hover:bg-primary-gold-dark text-white text-xs font-bold tracking-[0.2em] uppercase px-8 py-3.5 transition-colors duration-300 shadow-md"
                >
