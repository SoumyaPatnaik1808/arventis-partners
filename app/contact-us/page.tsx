              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-start gap-3 mt-4 mb-6">
                  ...
                  <label htmlFor="terms" className="font-sans text-sm text-black/75 leading-relaxed">
                    I agree to the{' '}
                    <a href="/terms-of-use" className="text-black underline hover:text-[#fa0249] transition-colors duration-300">
                      terms of use
                    </a>
                    {' '}and{' '}
                    <a href="/privacy-policy" className="text-black underline hover:text-[#fa0249] transition-colors duration-300">
                      privacy policy
                    </a>.
                  </label>
                </div>
