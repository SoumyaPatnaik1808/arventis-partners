    ...
    <div className="relative w-full overflow-hidden bg-white text-black min-h-screen font-sans">
      ...
      <section className="relative w-full py-20 px-6 md:px-16 text-black">
        <div className="max-w-4xl mx-auto space-y-6">
            ...
            >
              ...
              >
                <div className="space-y-1">
                  <span className="font-sans text-[10px] tracking-[0.25em] text-[#fc8403] uppercase font-bold block">
                    {faq.category}
                  </span>
                ...
                <div className={`w-8 h-8 rounded-full border border-black/15 flex items-center justify-center flex-shrink-0 transition-transform duration-300 ${
                  openIndex === idx ? 'rotate-180 bg-[#fc8403] text-white border-[#fc8403]' : 'text-black'
                }`}>
                  <ChevronDown size={18} />
                </div>
              </button>
          ...
          {/* Direct CTA Box */}
          <div className="scroll-fade-up mt-12 p-8 sm:p-10 bg-white border border-[#fc8403]/40 rounded-[1px] shadow-md flex flex-col items-center text-center gap-6">
            <div>
            ...
            <Link
              href="/contact-us"
              className="inline-flex items-center gap-2 bg-[#fc8403] hover:bg-black text-white text-xs font-bold tracking-[0.2em] uppercase px-8 py-4 transition-colors duration-300 shadow-md"
            >
